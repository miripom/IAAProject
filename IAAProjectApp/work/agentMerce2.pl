...
a(arrivo_al_passaggio):-a(message(agentPassaggio2,send_message(chiede_passaggio(2,2),var_Me))).

eve(attraversa):-write('Il passaggio mi ha appena concesso ad attraversare'),nl,a(termino_attraversamento).

a(termino_attraversamento):-write('Ho attraversato incrocio'),nl,a(message(agentPassaggio2,send_message(termino_attraversamento(2),var_Me))).
