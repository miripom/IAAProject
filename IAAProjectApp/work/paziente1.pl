...
eve(arriva_ospedale):-a(message(paziente2,send_message(avvisa_medico,var_Me))),a(avvisa_medico).

a(avvisa_medico):-a(message(medico,send_message(arriva_paziente(info_paziente),var_Me))).

eve(visita_paziente):-write('Il paziente 1 si fa visitare...'),a(message(medico,send_message(termina_visita(1),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_312203,var_Ontology,_312207),_312197),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_312241)),a(message(var_Ag,propose(var_A,[_312241],var_AgI))),retractall(ext_agent(var_Ag,_312279,var_Ontology,_312283)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_312077,var_Ontology,_312081),_312071),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_312147,var_Ontology,_312151)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_311965,var_Ontology,_311969),_311959),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_312021,var_Ontology,_312025)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_311529),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_311563),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_311345).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_311193),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_311141),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_311017,_311019)),clause(agente(_311039,_311041,_311043,var_S),_311035),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_310811,_310813,_310815,var_S),_310807),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_310911,[]),repeat,read(_310911,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_310911).
