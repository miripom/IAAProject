...
eve(go):-write('sto partendo'),a(message(agentTreno2,send_message(parti,var_Me))),a(message(agentMerce1,send_message(parti,var_Me))),once(a(arrivo_al_passaggio)).

a(arrivo_al_passaggio):-a(message(agentPassaggio1,send_message(chiede_passaggio(1,1),var_Me))).

eve(attraversa):-write('Il passaggio mi ha appena concesso ad attraversare'),nl,a(termino_attraversamento).

a(termino_attraversamento):-write('Ho attraversato incrocio'),nl,a(message(agentPassaggio1,send_message(termino_attraversamento(1),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_37413,var_Ontology,_37417),_37407),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_37451)),a(message(var_Ag,propose(var_A,[_37451],var_AgI))),retractall(ext_agent(var_Ag,_37489,var_Ontology,_37493)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_37287,var_Ontology,_37291),_37281),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_37357,var_Ontology,_37361)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_37175,var_Ontology,_37179),_37169),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_37231,var_Ontology,_37235)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_36739),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_36773),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_36555).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_36403),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_36351),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_36227,_36229)),clause(agente(_36249,_36251,_36253,var_S),_36245),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_36021,_36023,_36025,var_S),_36017),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_36121,[]),repeat,read(_36121,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_36121).
